  ...
  return (
    <div style={{ fontFamily:FONT, color:txt }}>
      ...
      {/* Tabs — segmented, horizontally scrollable.
           Radix Tabs.Root / List / Trigger provides:
             role="tablist" on the strip, role="tab" + aria-selected on each trigger,
             aria-controls/aria-labelledby linking triggers to panels, and
             arrow-key navigation between tabs (WAI-ARIA Tabs pattern). */}
      <Tabs.Root value={tab} onValueChange={setTab}>
      <Tabs.List style={{ display:"flex", gap:2, marginBottom:"1.4rem", overflowX:"auto", padding:4, background:bgS, border:`1px solid ${brd}`, borderRadius:999 }}>
        {TABS.map(t => (
          <Tabs.Trigger key={t} value={t} style={S.tab(tab===t)}>
